...
- [x] 006 - Add checkpoint-backed release image automation (`TODO/006-release-image-script.md`)
- [x] 002 - Merge JJ legacy confrepo content into current init-conf scaffold (`TODO/002-merge-legacy-confrepo.md`)
- [x] 001 - README rename + append-only Makefile version policy (`TODO/001-decomk-conf-cswg-readme.md`)
