# TODO-husig: Decomk Conf Cswg Readme
...
Affects: `README.md`, `TODO/TODO.md`, `TODO/TODO-husig-decomk-conf-cswg-readme.md`
...
Affects: `README.md`, `TODO/TODO-husig-decomk-conf-cswg-readme.md`

## Task 001 - README Rename + Version Policy

- [x] husig.1 Update README repo identity wording to `decomk-conf-cswg`.
- [x] husig.2 Replace README version-change section with append-only policy and examples.
- [x] husig.3 Document the allowed exception for pre-production testing/bugfix.
- [x] husig.4 Validate diff scope and record compliance artifacts in final handoff.
- [x] husig.5 Rewrite README as generic, low-churn guidance without mirrored live config details.
