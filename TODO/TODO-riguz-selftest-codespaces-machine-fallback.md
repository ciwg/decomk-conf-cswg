# TODO-riguz: Codespaces selftest machine fallback
...
Affects: `tools/selftest-codespaces.sh`, `README.md`, `TODO/TODO-riguz-selftest-codespaces-machine-fallback.md`.

## Subtasks

- [x] riguz.1 Lock the default fallback machine decision.
- [x] riguz.2 Implement `basicLinux32gb` fallback behavior in `tools/selftest-codespaces.sh`.
- [x] riguz.3 Document fallback and override examples in `README.md`.
- [x] riguz.4 Validate script syntax, help text, and docs.
