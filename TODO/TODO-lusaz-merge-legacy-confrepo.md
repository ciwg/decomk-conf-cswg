# TODO-lusaz: Merge Legacy Confrepo
...
Affects: `decomk.conf`, `Makefile`, `README.md`, `.devcontainer/devcontainer.json`, `.devcontainer/decomk-stage0.sh`, `TODO/TODO.md`, `TODO/TODO-lusaz-merge-legacy-confrepo.md`
...
Affects: `Makefile`, `TODO/TODO-lusaz-merge-legacy-confrepo.md`
...
Affects: `Makefile`, `README.md`, `TODO/TODO-lusaz-merge-legacy-confrepo.md`
...
Affects: `Makefile`, `decomk.conf`, `README.md`, `TODO/TODO-lusaz-merge-legacy-confrepo.md`

## Task 002 - Merge Legacy Confrepo Content

- [x] lusaz.1 Rebuild `decomk.conf` with tuple-only action variables and repo contexts (`fpga-workbench`, `mob-sandbox`).
- [x] lusaz.2 Rebuild `Makefile` with `Block*` baseline layering, shared/special target split, and explicit error handling.
- [x] lusaz.3 Update `.devcontainer` stage-0 and env contract to match current decomk templates and real conf URI.
- [x] lusaz.4 Rewrite `README.md` to document merged architecture, lifecycle actions, append-only policy, and customization workflow.
- [x] lusaz.5 Validate merged config using `decomk plan` across key contexts/actions.
- [x] lusaz.6 Record compliance artifacts and close TODO-lusaz.
- [x] lusaz.7 Split pinned apt tooling into versioned per-package stanzas and wire into `Block10`.
- [x] lusaz.8 Rename simple versioned apt package install targets to lowercase and update references/docs.
- [x] lusaz.9 Remove `apt_` prefix from simple package install targets and align references/docs.
- [x] lusaz.10 Replace `GO`/`PYTHON` env-manager targets with versioned distro package targets.
- [x] lusaz.11 Rename `PostCreateUser` target and references to `postCreateUserDemo`.
