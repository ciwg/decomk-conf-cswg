// Command mint-handle allocates a unique decomk-conf-cswg handle for a new record.
//
// Usage:
//
...
// prefixes it with the record kind, for example TODO-vapoj or DR-vapoj.
//
// Intent: Provide one local, collision-checked minting path for new TODO, TE,
// DI records. Source: DI-ruvop
package main
