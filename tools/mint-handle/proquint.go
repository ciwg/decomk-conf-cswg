...
// 4.29 billion values).
//
// We use proquint as the decomk-conf-cswg handle encoding because it is short,
// pronounceable, and trivially derivable from any 16- or 32-bit hash output
// without a curated wordlist or central registry.
//
// Intent: Keep new decomk-conf-cswg artifact IDs short and collision-checkable
// without relying on central integer or timestamp allocation. Source: DI-ruvop
const (
