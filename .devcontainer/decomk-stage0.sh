...
# Source: DI-001-20260416-223600 (TODO-husig)
...
# Source: DI-001-20260412-170500 (TODO-husig)
...
emit_stage0_identity_marker() {
  ...
  # Source: DI-007-20260423-180202 (TODO-hopun)
...
require_root_stage0() {
  ...
  # Source: DI-001-20260424-200248 (TODO-husig)
...
validate_remote_identity_before_escalation() {
  ...
  # Source: DI-001-20260424-215415 (TODO-husig)
  if [[ "${DECOMK_STAGE0_ESCALATED:-}" == "1" ]]; then
    return 0
  fi
...
stage0_error_handler() {
  ...
  # Source: DI-012-20260423-045339 (TODO-gopof)
...
sync_git_repo() {
  ...
  if [[ -d "$repo_dir/.git" ]]; then
    ...
    # Source: DI-008-20260412-122157 (TODO-riguz)
...
resolve_go_command() {
  ...
  # Source: DI-001-20260424-211213 (TODO-husig)
  local candidate
...
# Source: DI-004-20260422-193652 (TODO-fogup)
